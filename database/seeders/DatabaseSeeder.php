...
class DatabaseSeeder extends Seeder {
 public function run():void {
  ...
  $users=[['Administrador','jarevaloagu2@gmail.com','administrador','ADM','admin123'],['Carlos Mendoza','porteria@lamerced.gob.pe','portero','ADM','Hospital2026!'],['Rosa Castillo','admision@lamerced.gob.pe','admision','ADM','Hospital2026!'],['Dra. Elena Ramos','medicina@lamerced.gob.pe','profesional','MED','Hospital2026!'],['Lic. Juan Torres','laboratorio@lamerced.gob.pe','laboratorio','LAB','Hospital2026!'],['Dr. Miguel Silva','imagenes@lamerced.gob.pe','imagenes','IMG','Hospital2026!']];
  foreach($users as $i=>[$name,$email,$role,$service,$password]) DB::table('users')->insert(['name'=>$name,'email'=>$email,'password'=>Hash::make($password),'role'=>$role,'service_id'=>$sid[$service],'document_number'=>(string)(40000001+$i),'active'=>1,'created_at'=>$now,'updated_at'=>$now]);
