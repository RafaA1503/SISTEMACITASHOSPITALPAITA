...
<div class="login-brand-content"><div class="login-logo-wrap"><canvas id="loginScene" aria-hidden="true"></canvas><img src="{{ asset('logo-hospital-la-merced.png') }}" alt="Logo"></div><div><p>SISTEMA HOSPITALARIO</p><h1>Hospital Nuestra Señora de las Mercedes</h1><span>Acceso seguro para el personal autorizado.</span></div></div><small>Red de Salud · Paita · Piura</small></section>
